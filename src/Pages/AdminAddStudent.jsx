                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input onChange={(e) => setContactNumber(e.target.value)} required type="tel" class="form-control" id="numberId" />
                                        </div>
                                        <div className="form-group">
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input onChange={(e) => setFatherContactNumber(e.target.value)} type="tel" className="form-control" id="fathercnId" />
                                        </div>
                                        <div className="form-group">
                                            <label htmlFor="passwordId">Password</label>
                                            <input onChange={(e) => setPassword(e.target.value)} type="text" className={classnames("form-control",
                                                {
                                                    'is-invalid': error.name
                                                })} id="passwordId" />
                                            {error.name && (<div className="invalid-feedback">{error.name}</div>)}
