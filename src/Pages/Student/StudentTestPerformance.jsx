        ...
        <>
            {store.student.isAuthenticated ? <>
                ...
                <div className="container">
                    ...
                    {store.student.allMarks.InSem &&
                        <div className="row mt-3">
                            <div className="col-md-8 m-auto">
                                {store.student.allMarks.InSem.length !== 0 ? <>
                                    <h4>InSem</h4>
                                    <table className="table border">
                                        ...
                                        <tbody>
                                            {
                                                store.student.allMarks.InSem.map((res, index) =>
                                                    <tr key={index}>
                    ...
                    {store.student.allMarks.MidSem &&
                        <div className="row mt-3">
                            <div className="col-md-8 m-auto">
                                {store.student.allMarks.MidSem.length !== 0 ? <>
                                    <h4>MidSem</h4>
                                    <table className="table">
                                        ...
                                        <tbody>
                                            {
                                                store.student.allMarks.MidSem.map((res, index) =>
                                                    <tr key={index}>
                                                        <th scope="row">{index + 1}</th>
                                                        <td>{res.subject.subjectCode}</td>
                                                        <td>{res.subject.subjectName}</td>
